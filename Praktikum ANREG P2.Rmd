...
data <- read_excel("C:\\Users\\ASUS\\OneDrive\\문서\\DAFFA\\IPB\\STK\\ANREG\\NSC-2025.xlsx", sheet="Sheet2")
...
Didapatkan nilai $\hat\beta_0 = 79.71166 $ artinya nilai dugaan rataan indeks pembangunan manusia ketika rata-rata lama sekolah bernilai 0 persen adalah 79.71%, akan tetapi nilai 0 tidak ada dalam selang pengamatan rata-rata lama sekolah sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = -0.8221789$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Rata-rata lama sekolah berubah satu tahun adalah sebesar 8,22%

Koefisien determinasi yang dihasilkan adalah 0.1268565 atau 12.68% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase akses sanitasi layak adalah sebesar 12.68%, sisanya yaitu 87.32% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
