...
```{r}
library(readxl)
data_excel <- read_excel("C:\\Users\\ASUS\\Downloads\\Data-excel-pertemuan-1.xlsx")
```
...
```{r}
# Membaca file CSV
data_csv <- read.csv("C:\\Users\\ASUS\\Downloads\\Data csv pertemuan 1 (1).csv", sep = ";")
dataaa <- read.csv2("C:\\Users\\ASUS\\Downloads\\Data csv pertemuan 1 (1).csv")
```
